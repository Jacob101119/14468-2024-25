...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -58.63253363719661; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 50.43123133802842; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -8.773837227715314; // x position of the perpendicular encoder (in tick units)
    }
