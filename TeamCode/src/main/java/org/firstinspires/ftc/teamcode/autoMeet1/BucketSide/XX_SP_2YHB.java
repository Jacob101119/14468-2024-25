...
@Autonomous
public final class XX_SP_2YHB extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        Action moveToFirstYellowSample = robot.drive.actionBuilder(robot.drive.pose)
                ...
                .strafeToConstantHeading(new Vector2d(-51.5, -53.5))//move to first yellow sample
                .build();
        ...
        Action moveToHighBucket1 = robot.drive.actionBuilder(robot.drive.pose)
                ...
                .strafeToLinearHeading(new Vector2d(-46.4, -46.4), Math.toRadians(220))
                .build();
        ...
        Action moveToYellowSample2 = robot.drive.actionBuilder(robot.drive.pose)
                //.strafeToConstantHeading(new Vector2d(-14, -48))
                .strafeToLinearHeading(new Vector2d(-56.4, -53.5), Math.toRadians(90))//move to second yellow sample
                .build();
        Actions.runBlocking(moveToYellowSample2);
        ...
        Action moveToHighBucket2 = robot.drive.actionBuilder(robot.drive.pose)
                //.strafeToLinearHeading(new Vector2d(-48, -45), Math.toRadians(-90))
                .strafeToLinearHeading(new Vector2d(-46.5, -46.5), Math.toRadians(220))
                .build();
